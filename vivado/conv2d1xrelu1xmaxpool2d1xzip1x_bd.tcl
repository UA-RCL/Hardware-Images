...
################################################################
# This is a generated script based on design: conv2d1xrelu1xmaxpool2d1xzip1x
#
...
# source conv2d1xrelu1xmaxpool2d1xzip1x_script.tcl
...
set design_name conv2d1xrelu1xmaxpool2d1xzip1x
...
xilinx.com:hls:MaxPoolingKernel:1.0\
...
\
  ...
  # Create instance: conv2d_0_reset_logic, and set properties
  set conv2d_0_reset_logic [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 conv2d_0_reset_logic ]
  set_property CONFIG.C_SIZE {1} $conv2d_0_reset_logic


  # Create instance: conv2d_0_resetn_gpio, and set properties
  set conv2d_0_resetn_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 conv2d_0_resetn_gpio ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_GPIO_WIDTH {1} \
  ] $conv2d_0_resetn_gpio
  ...
  # Create instance: zip_0_reset_logic, and set properties
  set zip_0_reset_logic [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 zip_0_reset_logic ]
  set_property CONFIG.C_SIZE {1} $zip_0_reset_logic
  ...
  # Create instance: relu_0_dma, and set properties
  set relu_0_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 relu_0_dma ]
  set_property -dict [list \
    CONFIG.c_include_sg {0} \
    CONFIG.c_m_axi_mm2s_data_width {64} \
    CONFIG.c_m_axis_mm2s_tdata_width {32} \
  ...
  # Create instance: relu_0_resetn_gpio, and set properties
  set relu_0_resetn_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 relu_0_resetn_gpio ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_GPIO_WIDTH {1} \
  ] $relu_0_resetn_gpio
  ...
  # Create instance: relu_0_reset_logic, and set properties
  set relu_0_reset_logic [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 relu_0_reset_logic ]
  set_property CONFIG.C_SIZE {1} $relu_0_reset_logic
  ...
  # Create instance: MaxPoolingKernel_0, and set properties
  set MaxPoolingKernel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:MaxPoolingKernel:1.0 MaxPoolingKernel_0 ]

  # Create instance: maxpool2d_0_dma, and set properties
  set maxpool2d_0_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 maxpool2d_0_dma ]
  set_property -dict [list \
    CONFIG.c_include_sg {0} \
    CONFIG.c_m_axi_mm2s_data_width {64} \
    CONFIG.c_m_axis_mm2s_tdata_width {32} \
  ...
  # Create instance: maxpool2d_0_reset_logic, and set properties
  set maxpool2d_0_reset_logic [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 maxpool2d_0_reset_logic ]
  set_property CONFIG.C_SIZE {1} $maxpool2d_0_reset_logic


  # Create instance: maxpool2d_0_resetn_gpio, and set properties
  set maxpool2d_0_resetn_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 maxpool2d_0_resetn_gpio ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_GPIO_WIDTH {1} \
  ] $maxpool2d_0_resetn_gpio


  # Create instance: conv2d_0, and set properties
  set conv2d_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:conv2d:1.0 conv2d_0 ]

  # Create instance: conv2d_0_dma1, and set properties
  set conv2d_0_dma1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 conv2d_0_dma1 ]
  set_property -dict [list \
  ...
  connect_bd_intf_net -intf_net MaxPoolingKernel_0_output_stream [get_bd_intf_pins MaxPoolingKernel_0/output_stream] [get_bd_intf_pins maxpool2d_0_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net ReLU_0_output_stream [get_bd_intf_pins ReLU_0/output_stream] [get_bd_intf_pins relu_0_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins conv2d_0/s_axi_control] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins conv2d_0_resetn_gpio/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M06_AXI [get_bd_intf_pins conv2d_0_dma/S_AXI_LITE] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M06_AXI1 [get_bd_intf_pins ReLU_0/s_axi_control] [get_bd_intf_pins axi_smc/M06_AXI]
  connect_bd_intf_net -intf_net axi_smc_M07_AXI [get_bd_intf_pins relu_0_resetn_gpio/S_AXI] [get_bd_intf_pins axi_smc/M07_AXI]
  connect_bd_intf_net -intf_net axi_smc_M08_AXI [get_bd_intf_pins relu_0_dma/S_AXI_LITE] [get_bd_intf_pins axi_smc/M08_AXI]
  connect_bd_intf_net -intf_net axi_smc_M09_AXI [get_bd_intf_pins maxpool2d_0_dma/S_AXI_LITE] [get_bd_intf_pins axi_smc/M09_AXI]
  connect_bd_intf_net -intf_net axi_smc_M10_AXI [get_bd_intf_pins maxpool2d_0_resetn_gpio/S_AXI] [get_bd_intf_pins axi_smc/M10_AXI]
  connect_bd_intf_net -intf_net axi_smc_M11_AXI [get_bd_intf_pins MaxPoolingKernel_0/s_axi_config] [get_bd_intf_pins axi_smc/M11_AXI]
  connect_bd_intf_net -intf_net axi_smc_M12_AXI [get_bd_intf_pins conv2d_0_dma1/S_AXI_LITE] [get_bd_intf_pins axi_smc/M12_AXI]
  connect_bd_intf_net -intf_net conv2d_0_dma1_M_AXIS_MM2S [get_bd_intf_pins conv2d_0/kernel_stream] [get_bd_intf_pins conv2d_0_dma1/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net conv2d_0_dma1_M_AXI_MM2S [get_bd_intf_pins conv2d_0_dma1/M_AXI_MM2S] [get_bd_intf_pins axi_smc_1/S02_AXI]
  connect_bd_intf_net -intf_net conv2d_0_dma_M_AXIS_MM2S [get_bd_intf_pins conv2d_0/input_stream] [get_bd_intf_pins conv2d_0_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net conv2d_0_dma_M_AXI_MM2S [get_bd_intf_pins conv2d_0_dma/M_AXI_MM2S] [get_bd_intf_pins axi_smc_1/S00_AXI]
  connect_bd_intf_net -intf_net conv2d_0_dma_M_AXI_S2MM [get_bd_intf_pins conv2d_0_dma/M_AXI_S2MM] [get_bd_intf_pins axi_smc_1/S01_AXI]
  ...
  connect_bd_intf_net -intf_net maxpool2d_0_dma_M_AXIS_MM2S [get_bd_intf_pins MaxPoolingKernel_0/input_stream] [get_bd_intf_pins maxpool2d_0_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net maxpool2d_0_dma_M_AXI_MM2S [get_bd_intf_pins maxpool2d_0_dma/M_AXI_MM2S] [get_bd_intf_pins axi_smc_4/S00_AXI]
  connect_bd_intf_net -intf_net maxpool2d_0_dma_M_AXI_S2MM [get_bd_intf_pins maxpool2d_0_dma/M_AXI_S2MM] [get_bd_intf_pins axi_smc_4/S01_AXI]
  connect_bd_intf_net -intf_net relu_0_dma_M_AXIS_MM2S [get_bd_intf_pins ReLU_0/input_stream] [get_bd_intf_pins relu_0_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net relu_0_dma_M_AXI_MM2S [get_bd_intf_pins relu_0_dma/M_AXI_MM2S] [get_bd_intf_pins axi_smc_3/S00_AXI]
  connect_bd_intf_net -intf_net relu_0_dma_M_AXI_S2MM [get_bd_intf_pins relu_0_dma/M_AXI_S2MM] [get_bd_intf_pins axi_smc_3/S01_AXI]
  ...
  connect_bd_net -net fft_0_reset_logic_Res  [get_bd_pins conv2d_0_reset_logic/Res] \
  [get_bd_pins conv2d_0_dma/axi_resetn] \
  [get_bd_pins conv2d_0_dma1/axi_resetn] \
  [get_bd_pins conv2d_0/ap_rst_n]
  connect_bd_net -net fft_0_resetn_gpio_gpio_io_o  [get_bd_pins conv2d_0_resetn_gpio/gpio_io_o] \
  [get_bd_pins conv2d_0_reset_logic/Op1]
  connect_bd_net -net maxpool2d_0_reset_logic_Res  [get_bd_pins maxpool2d_0_reset_logic/Res] \
  [get_bd_pins maxpool2d_0_dma/axi_resetn] \
  [get_bd_pins MaxPoolingKernel_0/ap_rst_n]
  connect_bd_net -net maxpool2d_0_resetn_gpio_gpio_io_o  [get_bd_pins maxpool2d_0_resetn_gpio/gpio_io_o] \
  [get_bd_pins maxpool2d_0_reset_logic/Op1]
  connect_bd_net -net relu_0_reset_logic_Res  [get_bd_pins relu_0_reset_logic/Res] \
  [get_bd_pins relu_0_dma/axi_resetn] \
  [get_bd_pins ReLU_0/ap_rst_n]
  connect_bd_net -net relu_0_resetn_gpio_gpio_io_o  [get_bd_pins relu_0_resetn_gpio/gpio_io_o] \
  [get_bd_pins relu_0_reset_logic/Op1]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn  [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] \
  [get_bd_pins conv2d_0_reset_logic/Op2] \
  [get_bd_pins conv2d_0_resetn_gpio/s_axi_aresetn] \
  ...
  [get_bd_pins relu_0_resetn_gpio/s_axi_aresetn] \
  [get_bd_pins relu_0_reset_logic/Op2] \
  [get_bd_pins axi_smc_3/aresetn] \
  [get_bd_pins axi_smc_4/aresetn] \
  [get_bd_pins maxpool2d_0_reset_logic/Op2] \
  [get_bd_pins maxpool2d_0_resetn_gpio/s_axi_aresetn]
  ...
  [get_bd_pins conv2d_0_resetn_gpio/s_axi_aclk] \
  [get_bd_pins axi_smc_1/aclk] \
  [get_bd_pins zip_0_dma/s_axi_lite_aclk] \
  [get_bd_pins zip_0_resetn_gpio/s_axi_aclk] \
  [get_bd_pins axi_smc_2/aclk] \
  [get_bd_pins zip_0_dma/m_axi_mm2s_aclk] \
  [get_bd_pins zip_0_dma/m_axi_s2mm_aclk] \
  [get_bd_pins conv2d_0_dma/m_axi_mm2s_aclk] \
  [get_bd_pins conv2d_0_dma/m_axi_s2mm_aclk] \
  [get_bd_pins conv2d_0_dma/s_axi_lite_aclk] \
  [get_bd_pins relu_0_resetn_gpio/s_axi_aclk] \
  [get_bd_pins relu_0_dma/s_axi_lite_aclk] \
  [get_bd_pins relu_0_dma/m_axi_mm2s_aclk] \
  [get_bd_pins relu_0_dma/m_axi_s2mm_aclk] \
  ...
  [get_bd_pins maxpool2d_0_dma/s_axi_lite_aclk] \
  [get_bd_pins maxpool2d_0_dma/m_axi_mm2s_aclk] \
  [get_bd_pins maxpool2d_0_dma/m_axi_s2mm_aclk] \
  [get_bd_pins maxpool2d_0_resetn_gpio/s_axi_aclk] \
  [get_bd_pins conv2d_0_dma1/s_axi_lite_aclk] \
  [get_bd_pins conv2d_0_dma1/m_axi_mm2s_aclk] \
  [get_bd_pins MaxPoolingKernel_0/ap_clk] \
  [get_bd_pins ReLU_0/ap_clk] \
  [get_bd_pins ZIP_HLS_accel_0/ap_clk] \
  ...
  assign_bd_address -offset 0x80090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs MaxPoolingKernel_0/s_axi_config/Reg] -force
  assign_bd_address -offset 0x80020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ReLU_0/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs conv2d_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x800C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs conv2d_0_dma1/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs conv2d_0_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -with_name SEG_fft_0_resetn_gpio_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs conv2d_0_resetn_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x800A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs maxpool2d_0_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x800B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs maxpool2d_0_resetn_gpio/S_AXI/Reg] -force
  assign_bd_address -offset 0x80070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs relu_0_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs relu_0_resetn_gpio/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces conv2d_0_dma1/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces conv2d_0_dma1/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces conv2d_0_dma1/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces maxpool2d_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces relu_0_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]
