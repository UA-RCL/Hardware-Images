...
const unsigned A_ROWS = 1024;
const unsigned A_COLS = 1024;
const unsigned B_ROWS = 1024;
...
void complex_gemv_flt(cedr_cmplx_flt_type *input1, cedr_cmplx_flt_type *input2, cedr_cmplx_flt_type *output){
    ...
    wrapper_complex_gemv_flt_hw(input1, input2, output);
