...
void complex_gemm_int(cedr_cmplx_dbl_type *input1, cedr_cmplx_dbl_type *input2, cedr_cmplx_dbl_type *output){
    ...
    cedr_cmplx_flt_type input1_flt[A_ROWS * A_COLS];
    cedr_cmplx_flt_type input2_flt[A_COLS * B_COLS];
    cedr_cmplx_flt_type output_flt[A_ROWS * B_COLS];
    ...
    wrapper_complex_gemm_int_hw(input1_int, input2_int, output_int);
