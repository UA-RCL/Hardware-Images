...
################################################################
# This is a generated script based on design: fft_xdma_block_design
#
...
# source fft_xdma_block_design_script.tcl
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXIS_H2C_2 [get_bd_intf_pins xdma_0/M_AXIS_H2C_2] [get_bd_intf_pins xfft_1/S_AXIS_DATA]
  connect_bd_intf_net -intf_net xdma_0_M_AXIS_H2C_3 [get_bd_intf_pins xdma_0/M_AXIS_H2C_3] [get_bd_intf_pins xfft_1/S_AXIS_CONFIG]
  ...
  connect_bd_intf_net -intf_net xfft_1_M_AXIS_DATA [get_bd_intf_pins xdma_0/S_AXIS_C2H_1] [get_bd_intf_pins xfft_1/M_AXIS_DATA]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins xfft_0/aclk] [get_bd_pins xfft_1/aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins xfft_0/aresetn] [get_bd_pins xfft_1/aresetn]
