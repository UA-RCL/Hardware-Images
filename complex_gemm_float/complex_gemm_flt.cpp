...
void complex_gemm_flt(cedr_cmplx_flt_type *input1, cedr_cmplx_flt_type *input2, cedr_cmplx_flt_type *output){
...
wrapper_complex_gemm_flt_hw(input1, input2, output);
